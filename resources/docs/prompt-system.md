...
| CodeGraph narrative | `app/models/services/CodeGraphNarrativeService.bx` | `codegraph-narrative.v1`; summaries cite snapshot cluster/node ids | Shared schema/validator and one same-contract repair retry |
